...
const FooterMain = () => {
    return (
        <div className="footer__main">
            <Link to="/" className="footer__logo _footer-title">Med.</Link>
            ...
            <div className="footer__contacts contacts-footer">
                <Link to="/location" className="contacts-footer__item _icon-location">г. Москва, ул. Примерная, д. 1</Link>
                <Link to="/tel:+74950000000" className="contacts-footer__item _icon-phone">+7 (495) 000-00-00</Link>
                <Link to="/" target="_blank" className="contacts-footer__item">demo.example.com</Link>
            </div>
        </div>
    );
}
