    ...
    return (
        <div className="footer__main">
            ...
            <div className="footer__contacts contacts-footer">
                <Link to={ROUTES.location} className="contacts-footer__item _icon-location">{primaryBranch.address}</Link>
                <Link to={`tel:${CLINIC_PHONE_HREF}`} className="contacts-footer__item _icon-phone">{primaryBranch.phone}</Link>
                <a href={`mailto:${CLINIC_EMAIL}`} className="contacts-footer__item">{CLINIC_EMAIL}</a>
