            ...
            <section className="page__base base-block">
                <div className="base-block__container _container">
                    <div className="base-block__content notFound">
                        ...
                        <div className="notFound__text">Наш сайт находится в разработке и, возможно, в скором времени на этой странице появится контент. В любом случае проверьте ссылку на правильность и вернитесь через некоторое время</div>
